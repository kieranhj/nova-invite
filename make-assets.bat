...
python bin/png2bbc.py --quiet -o build/image_nova.bin ./data/images/nova-logo_v03_no_twenty.png 4
python bin/png2bbc.py --quiet -o build/image_nova3.bin ./data/images/ready_3novas_v03_no_twenty.png 4
rem python bin/png2bbc.py --quiet -o build/image_nova2020.bin ./data/images/ready_novatidy.png 4
...
rem bin\exomizer.exe level -M256 -c build/image_nova2020.bin@0x0000 -o build/image_nova2020.exo
