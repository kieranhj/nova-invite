...
python bin\png2bbcfont.py --transparent-rgb 0 255 0 --transparent-output 0 --glyph-dim 24 36 -o build\font24x36_rle.bin --rle --quiet data\fonts\24_x_36_1_col_v02.png 4
